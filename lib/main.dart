...
Future<void> main() async {
  ...
  await Supabase.initialize(
    url: "https://kcijbdicijqpblwwnvmc.supabase.co",
    ...
    anonKey:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtjaWpiZGljaWpxcGJsd3dudm1jIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ1MTE3MjMsImV4cCI6MjA1MDA4NzcyM30.6b6Z0OrPT1PdRgAz0W0-4ssva18GhAisqeGJlXZiSNk",
  );
  runApp(const MyApp());
}
